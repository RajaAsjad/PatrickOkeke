		...
		<div class="book-form-shell">
			<div class="book-form-body">
				<div class="book-form-banner">
					<h3>Add New Book</h3>
					<p>Create a product with cover, price, and downloadable file</p>
				</div>

				@include('admin.books.partials.form-fields')

				<div class="book-form-actions">
					<button type="submit" class="book-btn-submit"><i class="fa fa-plus"></i> Add Book</button>
